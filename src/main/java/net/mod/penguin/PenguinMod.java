...
public class PenguinMod {
	public static final Logger LOGGER = LogManager.getLogger(PenguinMod.class);
	...
	public PenguinMod() {
		...
		PenguinModBlocks.REGISTRY.register(bus);

		PenguinModItems.REGISTRY.register(bus);

		PenguinModTabs.REGISTRY.register(bus);
